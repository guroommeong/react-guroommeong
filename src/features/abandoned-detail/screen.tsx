...
export const AbandonedDetail = () => {
  ...
  // 서버 데이터가 공백을 끼고 응답을 하는 경우가 있어서 예외처리
  const precaution = {
    소형: '소형견은 체구가 작아 쉽게 다칠 수 있으므로 높은 곳에서의 낙상을 주의해야 하고, 체온 유지에 신경 써야 합니다.',
    ' 소형':
      '소형견은 체구가 작아 쉽게 다칠 수 있으므로 높은 곳에서의 낙상을 주의해야 하고, 체온 유지에 신경 써야 합니다.',
    ...
    ' 대형':
      '대형견은 체구가 크고 활동량이 많아 다칠 위험이 높습니다. 높은 곳에서의 낙상을 주의해야 하고, 체온 유지에 신경 써야 합니다.',
  };
